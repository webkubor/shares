  ...
  <div class="home-page page-transition">
      ...
      <div class="hero-container">
        <div class="hero-content animate-fadeInUp animate-delay-200">
          <div class="profile-section" @mouseenter="onProfileHover" @mouseleave="onProfileLeave">
            ...
            <p class="profile-title">Digital Craftsman & Creative Developer</p>
          </div>
    ...
    <section class="nav-section animate-fadeInUp animate-delay-600">
      ...
      <div class="nav-container">
        ...
        <div class="nav-cards">
          <router-link to="/tools" class="nav-card" @mouseenter="onCardHover" @mouseleave="onCardLeave">
          ...
          <router-link to="/projects" class="nav-card" @mouseenter="onCardHover" @mouseleave="onCardLeave">
            <div class="card-content">
              <div class="card-icon-wrapper">
